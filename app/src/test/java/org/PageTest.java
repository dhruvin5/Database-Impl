...
// assertEquals(page.insertRow(new Row(null, null)), -1, "Page cannot add null
// row");
// //Test if page can add row with null movieId
// assertEquals(page.insertRow(new Row(movieId, null)), -1, "Page cannot add
// null movieId");
// //Test if page can add row with null title
// assertEquals(page.insertRow(new Row(null, title)), -1, "Page cannot add null
// title");
...
// // Test if GetRow works by getting a row that is and not in the page,
// verifying if the data stored is corrected
// @Test
// void testGetRow() {
// //creates a page
// PageImpl page = new PageImpl(1);
...
// // Checks if IsFull works by checking the status of the page as we add more
// rows
// @Test
// void testIsFull() {
// PageImpl page = new PageImpl(1);
...
// assertEquals(-1, page.insertRow(new Row(new byte[9], new byte[30])), "Page
// cannot add another row");
// }
...
// assertEquals(i, page.getPid(), "Page ID should match - Retrieved: " +
// page.getPid() + " Expected: " + i);
// }
// // Checks if the page id is correct when the page id is negative
// PageImpl page = new PageImpl(-1);
// assertNotNull(page, "Page object is not null");
// assertEquals(-1, page.getPid(), "Page ID should match - Retrieved: " +
// page.getPid() + " Expected: " + -1);
