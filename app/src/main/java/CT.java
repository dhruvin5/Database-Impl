...
public class CT {
    public static void main(String[] args) {
        String Postgres_output = "/Users/simranmalik/645-Lab-32966720340112693401883534060222/app/sim_output_files/Updated_PSQL_Ba_Bm_output.csv";
        String LAB3_output = "/Users/simranmalik/645-Lab-32966720340112693401883534060222/app/Updated_LAB3(Ba-Bm)_output_sim20.csv";
        ...
        //System.out.println("Output LAB3_output name:" +LAB3_output);
    ...
    private static Set<String> readnormalisedCSV(String filePath, boolean skipHeader) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            String line;
            if (skipHeader) br.readLine(); // skipping header if skipHeader bool is false

            while ((line = br.readLine()) != null) {
                line = line.trim().replace("\uFFFD", ""); // trimming corrupted chars

                int lastComma = line.lastIndexOf(',');
                if (lastComma == -1) continue; // skipping tuples with malformation
