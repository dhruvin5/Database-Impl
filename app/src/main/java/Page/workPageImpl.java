...
public class workPageImpl implements Page {
    ...
    public Row getRow(int rowId) {
        ...
        byte[] category = Arrays.copyOfRange(rows, offset, (offset += this.categorySize));
    ...
    public int insertRow(Row row) {
        ...
        copyAndPaste(row.personId, this.personIdSize, (offset += this.movieIdSize));
        copyAndPaste(row.category, this.categorySize, (offset += this.personIdSize));
