...
public class MaterializedPageImpl implements Page {
    // has the row count
    ...
    public Row getRow(int rowId) {
        ...
        return new materializedRow(movieId, personId);
    }
